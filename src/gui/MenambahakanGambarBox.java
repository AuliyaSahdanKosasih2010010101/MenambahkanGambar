...
public class MenambahakanGambarBox extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gui/4bb25de78fad13f3cdd0e16cfd0a923e.jpg"))); // NOI18N
        pCardLayout.add(jLabel2, "0");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gui/5bb473ac8789548f4b3cd838be3617c7.jpg"))); // NOI18N
        pCardLayout.add(jLabel3, "1");

        jLabel4.setIcon(new javax.swing.ImageIcon("C:\\Users\\Sahdan\\Pictures\\Walpaper\\d1b18c6ff7f781ba0968a7a7bf72f39f.jpg")); // NOI18N
        ...
        pilihanpilihCard.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Walpaper 3d Power Ranger", "Walpaper 3d Neon", "Walpaper 3d Astronot", " " }));
